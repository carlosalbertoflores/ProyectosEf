...
public class sedes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Ingrese el codigo de Sede:");
        ...
        jLabel1.setText("Mantenimiento de Sedes");
        ...
        jLabel3.setText("Nombre de Sede:");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Estatus de Sede:");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/umg4", "root", "");
            PreparedStatement pst = cn.prepareStatement("update sedes set codigo_sedes = ?, nombre_sedes = ?, estatus_sedes = ?  where ID = " + ID);
