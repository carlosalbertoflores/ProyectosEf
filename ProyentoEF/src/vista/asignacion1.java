 ...
 * @author PERSONAL
 */
public class asignacion1 extends javax.swing.JFrame {
     ...
     */
     ...
     String BD = "jdbc:mysql://localhost/proyectoEF";
    String Usuario = "root";
    String Clave = "";
    public asignacion1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jInternalFrame1.setTitle("Asignación de Cursos Alumnos");
        jInternalFrame1.setVisible(true);
        jInternalFrame1.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Codigo Carrera:");
        jInternalFrame1.getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, -1, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Codigo Sede:");
        jInternalFrame1.getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 178, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Codigo Jornada:");
        jInternalFrame1.getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 213, -1, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("Ingresa el código de Asignacion: ");
        jInternalFrame1.getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, -1, -1));

        txt_buscar.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jInternalFrame1.getContentPane().add(txt_buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 520, 30));
        ...
        jInternalFrame1.getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 80, 140, 40));
        ...
        jInternalFrame1.getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 400, 150, 40));
        ...
        jInternalFrame1.getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 400, 140, 40));
        ...
        jInternalFrame1.getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 400, 150, 40));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("Codigo Seccion:");
        jInternalFrame1.getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 241, -1, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setText("Codigo Aula:");
        jInternalFrame1.getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, -1, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Codigo Curso:");
        jInternalFrame1.getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 306, -1, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("Carnet Alumno:");
        jInternalFrame1.getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 344, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(cbx_seccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 234, 130, -1));

        lbl_seccion.setText("Codigo");
        jInternalFrame1.getContentPane().add(lbl_seccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 234, -1, -1));

        lbl_aula.setText("Codigo");
        jInternalFrame1.getContentPane().add(lbl_aula, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 270, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(cbx_aula, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 130, -1));
        ...
        jInternalFrame1.getContentPane().add(cbx_curso, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 306, 130, -1));

        lbl_curso.setText("Codigo");
        jInternalFrame1.getContentPane().add(lbl_curso, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 309, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(cbx_alumno, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 344, 130, -1));

        lbl_alumno.setText("Codigo");
        jInternalFrame1.getContentPane().add(lbl_alumno, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 347, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 150, 654, 124));
        ...
        jInternalFrame1.getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 280, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(cbx_sede, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 178, 130, -1));

        lbl_sede.setText("Codigo");
        jInternalFrame1.getContentPane().add(lbl_sede, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 178, -1, -1));
        ...
        jInternalFrame1.getContentPane().add(cbx_carrera, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 130, -1));
        ...
        jInternalFrame1.getContentPane().add(cbx_jornada, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 206, 130, -1));

        lbl_carrera.setText("Codigo");
        jInternalFrame1.getContentPane().add(lbl_carrera, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 150, -1, -1));

        lbl_jornada.setText("Codigo");
        jInternalFrame1.getContentPane().add(lbl_jornada, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 206, -1, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(jInternalFrame1, javax.swing.GroupLayout.PREFERRED_SIZE, 1223, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(jInternalFrame1, javax.swing.GroupLayout.PREFERRED_SIZE, 538, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
  ...
  public void Tabla() {
    ...
    private void cbx_carreraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbx_carreraActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection(BD, Usuario, Clave);
            PreparedStatement pst = cn.prepareStatement("select  from codigo_carrera where codigo_carrera=?");
            ...
            if (rs.next()) {
                cbx_carrera.addItem("codigo_carrera");
                lbl_carrera.setText(rs.getString("codigo_carrera"));
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(asignacion1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new asignacion1().setVisible(true);
            }
        });
    }
